...
if __name__ == '__main__':
    paralog = ['01', '02']
    Force = None
    alignment_file = './Pillar4932Unswapped.fasta'
    newicktree = './Pillar4932Unswapped.newick'
    Force = {5:0}
    model = 'MG94'  # choose from 'HKY' and 'MG94'
    save_folder = './save/'
    check_folder(save_folder)
    save_name = save_folder + model + '4932New_Unswapped_Forced_Clocked_1.txt'

    summary_folder = './summary/'
    check_folder(summary_folder)

    test = ReCodonGeneconv( newicktree, alignment_file, paralog, Model = model, Force = Force, clock = True, save_path = './save/', save_name = save_name,
