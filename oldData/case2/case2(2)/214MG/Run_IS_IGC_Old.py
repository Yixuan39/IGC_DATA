...
if __name__ == '__main__':
    paralog = ['01', '02']
    Force = None
    alignment_file = './Pillar214Changed.fasta'
    newicktree = './Pillar214Changed.newick'
    Force = None
    model = 'MG94'  # choose from 'HKY' and 'MG94'
    save_folder = './save/'
    check_folder(save_folder)
    save_name = save_folder + model + '2nd214.txt'
    ...
    test = ReCodonGeneconv( newicktree, alignment_file, paralog, Model = model, Force = Force, clock = None, save_path = './save/', save_name = save_name,
                            tau=4.662947e-01, omega=8.605070e-02, kappa=1.634718e+00, inibl=0.01 )
    test.get_mle()
