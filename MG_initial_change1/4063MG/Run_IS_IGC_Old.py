...
if __name__ == '__main__':
    paralog = ['01', '02']
    Force = None
    alignment_file = './Pillar4063Changed.fasta'
    newicktree = './Pillar4063Changed.newick'
    Force = None
    model = 'MG94'  # choose from 'HKY' and 'MG94'
    save_folder = './save/'
    check_folder(save_folder)
    save_name = save_folder + model + '4063(2).txt'
    ...
    test = ReCodonGeneconv( newicktree, alignment_file, paralog, Model = model, Force = Force, clock = None, save_path = './save/', save_name = save_name,
                            tau=1.818528e-01, omega=3.292246e-02, kappa=1.584088e+00, inibl=0.01 )
    test.get_mle()
