...
IGC2_Full_noforce_noclock_newNode <- ListFunction("IGC2_Full_noforce_noclock2", "List")
```
...
```{r}
# update
IGC1_Full_noforce_noclock_opt1 <- ListFunction("IGC1_Full_noforce_noclock_opt1", "List")
IGC1_Full_noforce_noclock_update <- comparell(IGC1_Full_noforce_noclock, IGC1_Full_noforce_noclock_opt1)
```